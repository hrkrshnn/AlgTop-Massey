...
*** TODO 4.2
    ...
    We probably have to make use of the explicit construction. I'm
    guessing that one has to prove that each $G'_i$, when represented
    as a subgroup of the permutation group, will be the the subgroup
    of the representation of $G_i$. 
